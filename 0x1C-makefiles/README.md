...
> specific to make and Makefiles in Unix. [These files are used for compiling.](https://github.com/schoolschool/0x1B.c) Usage: ```make [all/clean/oclean/fclean/re] -f [file]```
